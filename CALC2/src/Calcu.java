...
public class Calcu extends JFrame {
	...
	public Calcu() {
		...
		zero.addActionListener(num); nine.addActionListener(num); eight.addActionListener(num);
		seven.addActionListener(num); six.addActionListener(num); five.addActionListener(num);
		four.addActionListener(num); three.addActionListener(num); two.addActionListener(num);
		one.addActionListener(num);  
		  
		decimal.addActionListener(num); negative.addActionListener(num);
		delete.addActionListener(num);
		add.addActionListener(cal); sub.addActionListener(cal); multiply.addActionListener(cal);
		div.addActionListener(cal); equals.addActionListener(cal); reset.addActionListener(cal); 
